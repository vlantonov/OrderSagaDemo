...
- Multi-stage Dockerfiles per service — builder: `golang:1.25-alpine`; runtime: `gcr.io/distroless/static-debian12`.
...
- GitHub Actions **CI workflow** (`.github/workflows/ci.yml`): build · vet · race-test · golangci-lint v2.13.2 · govulncheck (blocking) · buf lint; triggers on push/PR to `main`.
